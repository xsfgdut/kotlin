...
open class WrappedTypeParameterDescriptor(
    ...
    //override fun getUpperBounds() = error("don't ask wrapped descriptors about their types. You'll get killed.") //owner.superTypes.map { it.toKotlinType() }
...
open class WrappedPropertyDescriptor(
    ...
    override fun getDispatchReceiverParameter(): ReceiverParameterDescriptor? =
        owner.getter?.descriptor?.dispatchReceiverParameter ?: owner.setter?.descriptor?.dispatchReceiverParameter
    ...
    override fun getExtensionReceiverParameter(): ReceiverParameterDescriptor? =
        owner.getter?.descriptor?.extensionReceiverParameter ?: owner.setter?.descriptor?.extensionReceiverParameter
